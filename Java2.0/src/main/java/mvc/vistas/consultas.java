...
public class consultas {
	...
	public consultas() {
		...
		buttonadd1.setBounds(426, 177, 90, 78);
		...
		buttonadd2.setBounds(426, 304, 90, 78);
		...
		buttonadd3.setBounds(426, 458, 90, 78);
		...
		lblNewLabel_1.setFont(new Font("Academy Engraved LET", Font.PLAIN, 65));
		lblNewLabel_1.setBounds(528, 188, 285, 89);
		panel.add(lblNewLabel_1);

		lblNewLabel_2 = new JLabel("Áreas");
		lblNewLabel_2.setFont(new Font("Academy Engraved LET", Font.PLAIN, 65));
		lblNewLabel_2.setBounds(528, 319, 179, 89);
		panel.add(lblNewLabel_2);

		lblNewLabel_3 = new JLabel("Proyectos Integradores");
		lblNewLabel_3.setFont(new Font("Academy Engraved LET", Font.PLAIN, 65));
		lblNewLabel_3.setBounds(528, 468, 711, 89);
